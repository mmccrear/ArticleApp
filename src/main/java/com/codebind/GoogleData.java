...
public class GoogleData {
    ...
    private static final java.io.File DATA_STORE_DIR =
            new java.io.File(System.getProperty("user.home"), ".credentials/sheets.googleapis.com-java-quickstart");
    ...
    public static List<List<Object>> getSheetsData(String spreadsheetId, String range) {
